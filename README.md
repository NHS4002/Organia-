...
Sistema de Energia: As tarefas quando são criadas, é selecionado quanto de "energia" é necessário para concluí-las, e no dia, o usuário seleciona sua disposição para concluir
as tarefas.
